...
public class testParser {
  ...
  public static void main(String[] args) throws IOException {
    ...
    JavaSource src = builder.addSource(new File("/home/admin/mahmoud/work/bigdata/livy-zeppelin/incubator-zeppelin/beam/src/main/java/org/apache/beam/examples/MinimalWordCount.java"));
