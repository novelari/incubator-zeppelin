...
public class WordCount {
  ...
  public static void main(String[] args) {
    ...
    p.apply(TextIO.Read.named("ReadLines").from("/home/admin/mahmoud/work/bigdata/beam/shakespeare/file1.txt"))
     .apply(new CountWords())
     .apply(MapElements.via(new FormatAsTextFn()))
     .apply(TextIO.Write.named("WriteCounts").to("/home/admin/mahmoud/work/bigdata/beam/shakespeare/"));
