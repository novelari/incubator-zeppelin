...
public class WordCount {
  ...
  public static void main(String[] args) {
    ...
    p.apply(
        TextIO.Read.named("ReadLines").from(
            "/home/admin/mahmoud/work/bigdata/beam/shakespeare/file1.txt"))
        .apply(new CountWords())
        .apply(MapElements.via(new FormatAsTextFn()))
        .apply(
            TextIO.Write.named("WriteCounts").to(
                "/home/admin/mahmoud/work/bigdata/beam/shakespeare/"));
  ...
  static class ExtractWordsFn extends DoFn<String, String> {
    private final Aggregator<Long, Long> emptyLines = createAggregator("emptyLines",
        new Sum.SumLongFn());
   ...
   *
   * <p>
   * Concept #3: This is a custom composite transform that bundles two transforms (ParDo and Count)
   ...
   *
   * <p>
   * Concept #4: Defining your own configuration options. Here, you can add your own arguments to be
  ...
  public static interface WordCountOptions extends PipelineOptions {
    ...
    @Default.String("/home/admin/mahmoud/work/bigdata/beam/shakespeare/count.txt")
    String getOutput();
    ...
    public static class OutputFactory implements DefaultValueFactory<String> {
      ...
      public String create(PipelineOptions options) {
        if (options.getTempLocation() != null) {
          return GcsPath.fromUri(options.getTempLocation()).resolve("counts.txt").toString();
        } else {
