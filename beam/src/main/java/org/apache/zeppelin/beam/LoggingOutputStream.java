...
public class LoggingOutputStream extends OutputStream {
   ...
   */
  public LoggingOutputStream(Category cat, Priority priority) throws IllegalArgumentException {
    if (cat == null) {
   ...
   *              if an I/O error occurs. In particular, an <code>IOException</code> may be thrown
