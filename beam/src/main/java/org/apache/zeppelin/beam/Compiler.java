...
public class Compiler {
  ...
  public static void main(String[] args) {
    ...
    // String base = "src/main/java/com/novelari/staticrepl/testclasses";
    // String class1name = Class1.class.getCanonicalName();
    // String class1Code = FileUtil.readUTF8(base+"/Class1.java");
    // System.out.println(class1name);
    // System.out.println(class1Code);

    try {
      // Class<?> helloClass = Compiler.compile(class1name, class1Code);
      Class<?> helloClass = Compiler.compile("com.novelari.staticrepl.HelloClass",
          sourceCode.toString());
      if (helloClass != null) {
